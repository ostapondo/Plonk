...
<p align="center">
  ...
  <img alt="MCP" src="https://img.shields.io/badge/MCP-21_tools-8b5cf6?style=flat-square">
...
<p align="center">
  <img src="docs/ways.svg" width="720"
       alt="Four cards, one per way to move a window: drag it and the zones light up, hold ⌘ for two at once; ⌃⌥1 to ⌃⌥9 for the numbered zones with ⌃⌥0 as the oops key; ⌃⌥V to say it, offline and on-device; or ask an agent, through twenty-one MCP tools">
</p>
...
Twenty-one tools across state, layouts, workspaces, zones, keep-awake,
