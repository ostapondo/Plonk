...
extension LocalizedStringResource {
    ...
    static let paletteHintNavigate = Self.key("palette.hintNavigate")
    static let paletteHintRun = Self.key("palette.hintRun")
    static let paletteHintClose = Self.key("palette.hintClose")
